                                    ...
                                    <select name="driver_id" id="driver_id" class="form-control select2">
                                        ...
                                        @foreach ($drivers as $driver)
                                            <option value="{{ $driver->id }}"
                                                {{ request()->driver_id == $driver->id ? 'selected' : '' }}>{{ $driver->name }}
                                            </option>
                                        @endforeach
                                    </select>

                                    <label for="from-date">من</label>
                                    <input type="date" name="from_date" id="from-date" value="{{ request()->from_date }}"
                                        class="form-control">

                                    <label for="to-date">الى</label>
                                    <input type="date" name="to_date" id="to-date" value="{{ request()->to_date }}"
                                        class="form-control">
